...
DROP USER GVien321 CASCADE;
DROP USER GVien322 CASCADE;
DROP USER GVu011 CASCADE;
DROP USER NVien082 CASCADE;
...
-- Trưởng khoa 
GRANT CONNECT, TRUONGKHOA TO TKhoa633 IDENTIFIED BY pwd CONTAINER = CURRENT;
-- Trưởng đơn vị KHMT cơ sở 1
GRANT CONNECT, TRUONGDONVI TO TDonVi081 IDENTIFIED BY pwd CONTAINER = CURRENT;
-- Trưởng đơn vị KHMT cơ sở 2
GRANT CONNECT, TRUONGDONVI TO TDonVi082 IDENTIFIED BY pwd CONTAINER = CURRENT;
-- Giảng viên khoa HTTT cơ sở 1
GRANT CONNECT, GIANGVIEN TO GVien321 IDENTIFIED BY pwd CONTAINER = CURRENT;
-- Giảng viên khoa HTTT cơ sở 2
GRANT CONNECT, GIANGVIEN TO GVien322 IDENTIFIED BY pwd CONTAINER = CURRENT;
-- Giáo vụ khoa MMT cơ sở 1
GRANT CONNECT, GIAOVU TO GVu011 IDENTIFIED BY pwd CONTAINER = CURRENT;
-- Nhân viên khoa KHMT
GRANT CONNECT, NHANVIEN TO NVien082 IDENTIFIED BY pwd CONTAINER = CURRENT ;
-- Sinh viên khoa HTTT cơ sở 1
GRANT CONNECT, SINHVIEN TO SVien321 IDENTIFIED BY pwd CONTAINER = CURRENT ;
-- Sinh viên khoa HTTT cơ sở 2
GRANT CONNECT, SINHVIEN TO SVien322 IDENTIFIED BY pwd CONTAINER = CURRENT;
...
INSERT INTO THONGBAO(NOIDUNG, OLS_COL) VALUES ('Thông báo dành cho tất cả Giảng viên khoa HTTT [...]', 2176);
INSERT INTO THONGBAO(NOIDUNG, OLS_COL) VALUES ('Thông báo dành cho Nhân viên khoa KHMT ở cơ sở 2 [...]', 642);
