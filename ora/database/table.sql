...
host sqlldr userid=QLTRUONGHOC/123123@"(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=0.tcp.ap.ngrok.io)(PORT=15702))(CONNECT_DATA=(SERVICE_NAME=XE)))" control=donvi.ctl;
host sqlldr userid=QLTRUONGHOC/123123@"(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=0.tcp.ap.ngrok.io)(PORT=15702))(CONNECT_DATA=(SERVICE_NAME=XE)))" control=nhansu.ctl;
...
host sqlldr userid=QLTRUONGHOC/123123@"(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=0.tcp.ap.ngrok.io)(PORT=15702))(CONNECT_DATA=(SERVICE_NAME=XE)))" control=sinhvien.ctl;
/
